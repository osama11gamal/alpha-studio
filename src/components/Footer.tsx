        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/careers" className="text-gray-400 hover:text-alpha-gold transition-colors font-sans border-b-2 border-transparent hover:border-alpha-gold pb-1 focus:outline-none focus:text-alpha-gold focus:border-alpha-gold">{language === 'en' ? 'Careers' : 'انضم إلينا'}</Link></li>
